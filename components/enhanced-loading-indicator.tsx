...
import { Search, Database, Brain, Sparkles, Loader2 } from 'lucide-react'
...
export function EnhancedLoadingIndicator({ searchStatus, isLoading }: EnhancedLoadingIndicatorProps) {
  ...
  const steps = [
    { icon: Search, text: 'Searching real estate sources' },
    { icon: Database, text: 'Analyzing market data' },
          ...
          {steps.map((step, index) => {
            ...
            return (
              <div key={index} className="flex flex-col items-center">
                ...
                <span className={`text-xs text-center transition-colors duration-300 max-w-16 ${
